...
public class JacksonGenerator {
   ...
   */
  public void generate(JsonValue jsonValue) {
    if (jsonValue == null) {
  ...
  private void generateArray(JsonArray jsonArray) {
  ...
  private void generateNumber(JsonNumber jsonValue) {
    CJNumber pNumber;
    try {
  ...
  private void generateObject(JsonObject jsonObject) {
