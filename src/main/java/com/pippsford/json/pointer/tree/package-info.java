/**
 * The motivation for this extension to the standard jakarta.json API is to enable the enforcement of a policy of what can be done with patches and what parts
 * of a JSON structure a user may legitimately create.
 *
